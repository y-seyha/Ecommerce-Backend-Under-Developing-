...
import { Router } from "express";
import { UserCartItemController } from "../controller/cartItem.controller.js";
import { authMiddleware } from "middleware/authMiddleware.js";
import { validate } from "middleware/validate.middleware.js";
import { CartItemValidator } from "valildators/cartItem.validator.js";

const router = Router();
const controller = new UserCartItemController();

router.get("/cart/:cartId/items", authMiddleware, controller.getItemsByCartId);
